...
export default {
	...
	computed: {
		 ...
		 userSetUp() {
		 	return this.$store.getters.userProfile.role.screens
		 },		 
		 load(){
		...
		layoutPicker() {
			return this.$store.getters.layoutPicker
		},
		roundedCorners() {
