	...
	<div class="layout-picker" :class="{'open':pickerOpened, 'pos-left': position === 'right'}">
		...
		<div class="picker-box">
			...
			<div class="selector-box">
				<span class="label">Ver Animación</span>
				<el-select v-model="viewAnimation" placeholder="Select" size="mini">
					<el-option label="Izquierda" value="fade-left"></el-option>
					<el-option label="Derecha" value="fade-right"></el-option>
					<el-option label="Arriba" value="fade-top"></el-option>
					<el-option label="Arriba Afuera" value="fade-top-in-out"></el-option>
					<el-option label="Abajo" value="fade-bottom"></el-option>
					<el-option label="Abajo y Afuerta" value="fade-bottom-in-out"></el-option>
					<el-option label="Desvanecerse" value="fade"></el-option>
					<el-option label="Ninguno" :value="false"></el-option>
				</el-select>
			</div>

			<div class="selector-box">
				<span class="label">Navegación</span>
				<el-select v-model="navPos" placeholder="Select" size="mini">
					<el-option label="Arriba" value="top"></el-option>
					<el-option label="Abajo" value="bottom"></el-option>
					<el-option label="Izquierda" value="left"></el-option>
					<el-option label="Derecha" value="right"></el-option>
					<el-option label="Ninguno" :value="false"></el-option>
				</el-select>
			</div>
			...
			<div class="selector-box">
				<span class="label">Pie de página</span>
				<el-radio-group v-model="footer" size="mini" v-if="navPos === 'left' || navPos === 'right'">
					<el-radio-button :label="'above'">encima</el-radio-button>
					<el-radio-button :label="'below'">detrás</el-radio-button>
					<el-radio-button :label="false">off</el-radio-button>
				</el-radio-group>
				<el-radio-group v-model="footer" size="mini" v-if="navPos !== 'left' && navPos !== 'right'">
			...
			<div class="selector-box">
				<span class="label">
					<small>Esquinas redondeadas </small>
					<el-tooltip effect="dark" placement="left-start">
						<div slot="content">Puede apreciar este efecto en las páginas que usan el "desplazamiento virtual".<br/></div>
			...
			<div class="selector-box">
				<span class="label">Estilos</span>
				<a class="theme-box" href="/" >
